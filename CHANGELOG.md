...
- The game starts only after the launcher's window has faded out and closed, on every path: after the logo, **Play without updating**, **Update and play**, and the countdown after an update asked for in the game. The launcher then waits for the game with no window.
